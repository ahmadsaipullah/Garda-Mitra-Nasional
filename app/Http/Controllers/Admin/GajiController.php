...
class GajiController extends Controller
{
            ...
            return DataTables::of($gaji)
                ...
                ->addColumn('actions', function ($row) {
                    return '<div class="btn-group">
                                    <button class="text-success h4 d-inline border-0" style="background: transparent" data-id="' . $row['id'] . '" id="cetak"><i class="fa fa-print"></i></button>
                                    <h4>|</h4>
    ...
    public function importgaji(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Gaji Berhasil Di Upload!');
    }
